...
public class Signup extends JFrame implements ActionListener{
    ...
    Signup(){
        ...
        ImageIcon img1 = new ImageIcon(ClassLoader.getSystemResource("ASimulatorSystem/icons/logo2.png"));
        Image i2 = img1.getImage().getScaledInstance(50, 50, Image.SCALE_DEFAULT);
        ImageIcon i3 = new ImageIcon(i2);
        JLabel l11 = new JLabel(i3);
        l11.setBounds(70, 20, 50, 50);
        add(l11);
